...
if GetResourceState("qb-core") ~= "started" then
    while true do 
        print("^0[^5Origen Admin^0] qb-core is not started, please make sure to start origen_admin after qb-core^0")
        Wait(2000)
    end
end
...
RegisterNetEvent('QBCore:Client:OnPlayerUnload', function()
    TriggerEvent("origen_admin:client:OnPlayerUnload")
end)

RegisterNetEvent("QBCore:Client:OnJobUpdate", function()
    TriggerEvent("origen_admin:client:OnJobUpdate")
end)
