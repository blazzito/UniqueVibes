---------- [STRINGS] ----------
Config.Language = "en" -- Lua notification language. Options: "en", "es", "fr", "pl", "ja", "zh".
...
Config.SendRobberyLogsToWebhook = false -- Turn this on after confirming the resource boots cleanly.
Config.RobberyLogWebhookBatchDelay = 8 -- Seconds to collect main robbery logs before sending one merged webhook log.
Config.RobberyActionLogMaxEntries = 150 -- Max main robbery action logs saved in config/robbery-action-logs.json. Lower this if the log file gets too large.
Config.RobberyActionLogPageSize = 15 -- Main robbery logs loaded per page in the tablet UI.
------------------------------
---------- [BOOLS] ----------
Config.Debug = false -- enables debug poly.
Config.AddStolenVehicleToPlayersGarage = false -- Add the vehicle to the players saved garage for ever when stealing a car from a crated car robbery. (its smart to make robbable car robberies really hard)
...
Config.PettyCrimeGlobalCooldowns = true -- True = petty object robberies and porch pirate cooldowns affect everyone. False = petty cooldowns only affect the player who triggered them.
---------- [INTAGERS] ----------

------------------------------
---------- [TABLES] ----------
------------------------------
Config.DefualPoliceJobs = {'police', 'bcso', 'leo', 'rangers', 'trooper', 'sasp'} -- These are default police jobs for bank truck robbery, lasers, reseting a step, 
------------------------------
Config.HouseRobberyPresetSettings = {
    targetLabel = "Break In",
    progressbarLabel = "Breaking into house",
    progressbarTime = 6500,
    cooldownTimer = 30,
    policeRequired = 0,
    alertChance = 100,
    minigameOption = "none",
    sendAlert = false,
    policeAlertHeader = "House Robbery Alert",
    policeAlert = "Suspicious activity reported at a house robbery.",
    policeJobs = Config.DefualPoliceJobs,
    alertCode = "10-90",
...
Config.HouseRobberyNpcs = { -- Random ped models used for placed home owners when a player enters a house robbery.
    "a_f_m_beach_01",
    "a_f_m_bevhills_01",
    "a_f_m_ktown_01",
    "a_f_m_prolhost_01",
...
Config.SellTraderPedModels = { -- Ped models available when placing Item Sell/Trader target NPCs.
    "s_m_y_dealer_01",
    "a_m_m_business_01",
    "a_m_y_business_02",
    "a_m_m_ktown_01",
...
Config.PettyCrimeObjectModels = { -- THIS IS JUST THE DEFAULT LOADED ONE (YOU ADJUST THESE ONLY IN THE MENU)
    { label = "Mailbox", model = "prop_letterbox_01" }, -- MORE MODELS TO ADD TO THE DEFAULT MAILBOX ROBBERY (prop_letterbox_02, prop_letterbox_03, prop_letterbox_04)
    { label = "Parking Meter", model = "prop_parknmeter_01" },
}
Config.PorchPirateBoxModels = {
    { label = "Cardboard Box", model = "prop_cs_cardbox_01" },
    { label = "Heist Box", model = "hei_prop_heist_box" },
    { label = "Postal Box", model = "prop_cardbordbox_04a" },
}

Config.HouseRobberyShellModels = {
    {
        label = "Furnished Mid Apartment",
        model = "k4_house4_furn",
        enterOffset = { x = 1.46, y = -10.33, z = 1.70, w = 0.0 },
    },
    {
        label = "Small Apartment Room",
        model = "lev_apartment_shell",
        enterOffset = { x = -0.46, y = -2.42, z = 1.39, w = 0.0 },
    },
    {
        label = "K4 V16 Low 1 Shell",
        model = "k4_v16low1_shell",
        enterOffset = { x = 4.71, y = -6.54, z = 1.21, w = 0.0 },
    },
    {
        label = "Trailer",
        model = "shell_trailer",
        enterOffset = { x = -1.4, y = -2.1, z = 3.3, w = 358.633972168 },
    },
    {
        label = "Modern Motel Room",
        model = "modernhotel_shell",
        enterOffset = { x = 4.98, y = 4.35, z = 1.16, w = 179.79 },
    },
    {
        label = "3655 Wild Oats Drive",
        model = "3655WildOatsDrive",
        shellType = "world",
        enterOffset = { x = -174.38, y = 497.59, z = 136.75, w = 195.87 },
    },
    {
        label = "Eclipse Towers Penthouse 2",
        model = "EclipseTowersPenthouse2",
        shellType = "world",
        enterOffset = { x = -779.21, y = 339.86, z = 196.69, w = 177.92 },
    },
}
