...
Translations = {
    ...
    ["Pending"] = "PENDIENTE",
    ["Approved"] = "APROBADO",
    ["RobberyRequests"] = "SOLICITUDES DE ROBO",
    ["ActiveRequests"] = "SOLICITUDES ACTIVAS",
    ["RequestDetail"] = "DETALLE DE SOLICITUD",
    ["NoRobberyRequests"] = "Sin solicitudes activas",
    ["SelectARequest"] = "Seleccioná una solicitud para ver el detalle",
    ["RequestedBy"] = "SOLICITADO POR",
    ["RequestedAt"] = "HORA",
    ["Participants"] = "PARTICIPANTES",
    ["RequiredCops"] = "POLICÍAS REQ.",
    ["ExpiresIn"] = "EXPIRA EN",
    ["Approve"] = "APROBAR",
    ["Reject"] = "RECHAZAR",
    ["RejectRequest"] = "RECHAZAR SOLICITUD",
    ["RejectReason"] = "Motivo de rechazo",
    ["RejectReasonPh"] = "Explicá por qué rechazás esta solicitud...",
    ["RejectReasonRequired"] = "El motivo es obligatorio.",
    ["ConfirmReject"] = "CONFIRMAR RECHAZO",
    ["MarkStarted"] = "MARCAR INICIADO",
    ["RequestApproved"] = "Solicitud aprobada — esperando que la banda inicie",
    ...
    ["FinishEdition"] = "FINALIZAR EDICIÓN",
    ...
    -- 01/04/2025 - Ems overrided translations
