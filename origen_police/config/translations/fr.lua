...
Translations = {
    ...
    ["Pending"] = "EN ATTENTE",
    ["Approved"] = "APPROUVÉ",
    ["RobberyRequests"] = "DEMANDES DE BRAQUAGE",
    ["ActiveRequests"] = "DEMANDES ACTIVES",
    ["RequestDetail"] = "DÉTAIL DE LA DEMANDE",
    ["NoRobberyRequests"] = "Aucune demande active",
    ["SelectARequest"] = "Sélectionnez une demande pour voir les détails",
    ["RequestedBy"] = "DEMANDÉ PAR",
    ["RequestedAt"] = "HEURE",
    ["Participants"] = "PARTICIPANTS",
    ["RequiredCops"] = "POLICIERS REQ.",
    ["ExpiresIn"] = "EXPIRE DANS",
    ["Approve"] = "APPROUVER",
    ["Reject"] = "REJETER",
    ["MarkStarted"] = "MARQUER COMME DÉMARRÉ",
    ["RequestApproved"] = "Demande approuvée — en attente du gang",
