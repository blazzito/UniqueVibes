...
Config.HolsterAllJobs = false -- If true, all jobs will be able to use the holster system, if false only the jobs in Config.AllowedHolster will be able to use it
Config.AllowedHolster = { -- This is the list of job categories, not job names, check config/jobs.lua for more information related to job categories
	"police"
}
