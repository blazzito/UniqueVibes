...
Config.HeliCam = {
    Enabled = true, -- Enable or disable the helicam system
    NightVision = true, -- Enable or disable the night vision mode of the helicam
    ThermalVision = true, -- Enable or disable the thermal vision mode of the helicam
}
