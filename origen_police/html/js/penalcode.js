codigoPenalFunctions = {
	loadCPFunctions: function () {
		fetch('LoadPolicePage', { page: 'penalcode' }).done((cb) => {
			if (cb.boss) {
				...
				$('.police-action-btn.add-capitulo').show();
				$('.police-action-btn.add-articulo').show();
				$('.police .app-codigo-penal .h-accion').removeClass('d-none');
				$('.police .app-codigo-penal .td-accion').removeClass('d-none');
			} else {
				
				$('.police-action-btn.add-capitulo').hide();
				$('.police-action-btn.add-articulo').hide();
	...
	$(document).on('click', '.police .app-codigo-penal .add-capitulo, .police .add-capitulo', function () {
		OpenModal(
		...
		$(document).on('click', '.police .app-codigo-penal .add-articulo, .police .add-articulo', function () {
			let capitulos = '';
			$(
				'.police ' +
					policeTabSelected +
