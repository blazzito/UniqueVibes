return {
	Weapons = {
		...
		['WEAPON_ASSAULTRIFLE22'] = {
			label = 'Assault Rifle22',
			weight = 4500,
			durability = 0.03,
			ammoname = 'rifle_ammo',
		},		
		...
		['WEAPON_DEMONGOLF'] = {
			label = 'Demon Golf Club',
			weight = 330,
			durability = 0.1,
		},
		['WEAPON_DEMONSWIFT'] = {
			label = 'Demon Knife v2',
			weight = 300,
			durability = 0.1,
		},
		['WEAPON_ICESWORD1'] = {
		...
		['WEAPON_TECDRACOPI'] = {
			label = 'Pistol Dracotec',
			weight = 1130,
			durability = 0.1,
			ammoname = 'pistol_ammo',
		},
		['WEAPON_DEMONPOOL'] = {
			label = 'Demon Pool Cue',
			weight = 146,
			durability = 0.1,
		},
	...
	Ammo = {
		...
		['sniper_ammo'] = {
			label = 'Munición de Francotirador',
			weight = 25,
			client = {
