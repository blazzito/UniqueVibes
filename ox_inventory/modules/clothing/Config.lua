...
--[[
		...
		You can change the command name if you wish, do so in the language file DPLocales/LANGUAGE.lua,
...
-- command[x].name is used as command name
Config.Commands = {
	["top"] = {
...
Config.ExtraCommands = {
	...
	[Lang("RESET")] = {
		Func = function() ExecuteCommand("pelo") end,
		Sprite = "reset",
		Desc = Lang("Reset2"),
		Name = Lang("Reset"),
		OffsetX = 0.12,
