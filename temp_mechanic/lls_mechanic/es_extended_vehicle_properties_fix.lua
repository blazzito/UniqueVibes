...
ESX.Game.SetVehicleProperties = function(vehicle, props)
	...
	-- Se reubica al final (tras aplicar color1/color2/pearlescentColor) y se relee el estado actual.
	if (props.color1Type or props.color2Type) then
		...
		if (props.color1Type) then
			SetVehicleModColor_1(vehicle, props.color1Type, curColor1, curPearlescent)
		end

		if (props.color2Type) then
			SetVehicleModColor_2(vehicle, props.color2Type, curColor2)
		end
	end
