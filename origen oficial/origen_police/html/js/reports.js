	...
	addPersonaInforme: function (name, citizenid) {
        ...
        <li class="list-group-item list-group-item-action scale-in" data-id="${citizenid}">
            <div class="d-flex align-items-center">
                ...
                <div class="ms-2 text-muted persona-cid"><i class="fa-solid fa-id-card me-1"></i> ${citizenid}</div>
            </div>
            ...
            <div class="multa-button">
                <i class="fa-solid fa-pen-to-square"></i> ${Translations.SendFine}
            </div>
        </li>
        `);
                        ...
                        <div class="col-12 p-0">
                            <div class="info-box m-1 mt-2">
                                <div class="d-flex justify-content-between align-items-center">
                                    <h4><i class="fa-solid fa-note-sticky"></i> ${Translations.ReportDescription}</h4>
                                </div>
									...
									cops += `
										<li class="list-group-item list-group-item-action scale-in" data-id="${cop.citizenid}">
											<div class="d-flex align-items-center">
												...
												<div class="ms-2 text-muted persona-cid"><i class="fa-solid fa-id-card me-1"></i> ${cop.citizenid}</div>
											</div>
											<div class="delete-button">
												<i class="fa-solid fa-trash"></i>
											</div>
						...
						if (cb.victims && isJsonString(cb.victims)) {
                            ...
                            <li class="list-group-item list-group-item-action scale-in" data-id="${victim.citizenid}">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-2 text-muted persona-cid"><i class="fa-solid fa-id-card me-1" aria-hidden="true"></i> ${victim.citizenid}</div>
                                </div>
                                <div class="delete-button">
                                    <i class="fa-solid fa-trash"></i>
                                </div>
						...
						if (cb.implicated && isJsonString(cb.implicated)) {
                            ...
                            <li class="list-group-item list-group-item-action scale-in" data-id="${
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-2 text-muted persona-cid"><i class="fa-solid fa-id-card me-1"></i> ${
										imp.citizenid
									}</div>
                                </div>
