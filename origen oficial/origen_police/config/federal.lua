Config.Federal = {
    JoinCinematic = false, -- If you want to enable the enter cinematic when entering the prison, set this to true
...
Config.DefaultExit = "Boling Broke" -- This is the default exit
