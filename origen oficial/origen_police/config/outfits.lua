-- Build the list of police job names dynamically from Config.JobCategory
-- so renaming the job in config/jobs.lua is enough, no need to touch this file.
local _policeJobNames = (function()
    local jobs = {}
