...
-- Tablet
    ...
    ["Pending"] = "FÜGGŐBEN",
    ["Approved"] = "JÓVÁHAGYVA",
    ["RobberyRequests"] = "RABLÁSI KÉRELMEK",
    ["ActiveRequests"] = "AKTÍV KÉRELMEK",
    ["RequestDetail"] = "KÉRELEM RÉSZLETEI",
    ["NoRobberyRequests"] = "Nincs aktív rablási kérelem",
    ["SelectARequest"] = "Válasszon ki egy kérelmet a részletek megtekintéséhez",
    ["RequestedBy"] = "KÉRTE",
    ["RequestedAt"] = "IDŐ",
    ["Participants"] = "RÉSZTVEVŐK",
    ["RequiredCops"] = "SZÜKSÉGES RENDŐRÖK",
    ["ExpiresIn"] = "LEJÁR",
    ["Approve"] = "JÓVÁHAGYÁS",
    ["Reject"] = "ELUTASÍTÁS",
    ["MarkStarted"] = "MEGKEZDVE",
    ["RequestApproved"] = "Kérelem jóváhagyva — várakozás a bandára",
