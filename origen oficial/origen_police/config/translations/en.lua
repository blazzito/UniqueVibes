...
Translations = {
    ...
    ["Pending"] = "PENDING",
    ["Approved"] = "APPROVED",
    ["RobberyRequests"] = "ROBBERY REQUESTS",
    ["ActiveRequests"] = "ACTIVE REQUESTS",
    ["RequestDetail"] = "REQUEST DETAIL",
    ["NoRobberyRequests"] = "No active robbery requests",
    ["SelectARequest"] = "Select a request to view details",
    ["RequestedBy"] = "REQUESTED BY",
    ["RequestedAt"] = "TIME",
    ["Participants"] = "PARTICIPANTS",
    ["RequiredCops"] = "REQUIRED COPS",
    ["ExpiresIn"] = "EXPIRES IN",
    ["Approve"] = "APPROVE",
    ["Reject"] = "REJECT",
    ["RejectRequest"] = "REJECT REQUEST",
    ["RejectReason"] = "Rejection reason",
    ["RejectReasonPh"] = "Explain why you are rejecting this request...",
    ["RejectReasonRequired"] = "Reason is required.",
    ["ConfirmReject"] = "CONFIRM REJECTION",
    ["MarkStarted"] = "MARK AS STARTED",
    ["RequestApproved"] = "Request approved — waiting for gang to start",
