...
import { FaHatCowboy, FaGlasses, FaHeadphones } from 'react-icons/fa';
import { GiWatch, GiHand } from 'react-icons/gi';
...
const Props = ({ settings, data, storedData, handlePropDrawableChange, handlePropTextureChange, propConfig }: PropsProps) => {
  ...
  return (
    <Section title={locales.props.title}>
      {propConfig.hats && (
        <Item title={locales.props.hats} icon={<FaHatCowboy />}>
          <Input
      ...
      {propConfig.glasses && (
        <Item title={locales.props.glasses} icon={<FaGlasses />}>
          <Input
      ...
      {propConfig.ear && (
        <Item title={locales.props.ear} icon={<FaHeadphones />}>
          <Input
      ...
      {propConfig.watches && (
        <Item title={locales.props.watches} icon={<GiWatch />}>
          <Input
      ...
      {propConfig.bracelets && (
        <Item title={locales.props.bracelets} icon={<GiHand />}>
          <Input
