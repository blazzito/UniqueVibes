...
function SetVehicleModData(vehicle, modType, data)
	...
	elseif (modType == 'color1') then
		ClearVehicleCustomPrimaryColour(vehicle)
		local color1, color2 = GetVehicleColours(vehicle)
		SetVehicleColours(vehicle, tonumber(data), color2)
	elseif (modType == 'color2') then
		ClearVehicleCustomSecondaryColour(vehicle)
		local color1, color2 = GetVehicleColours(vehicle)
		SetVehicleColours(vehicle, color1, tonumber(data))
	elseif (modType == 'paintType1') then
		-- FIX: el native necesita (vehicle, paintType, color, pearlescentColor).
