    ...
    ['main'] = {
        ...
        ['visual'] = {
            ...
            ['respray'] = {
                title = 'PINTURA',
                options = {
                    {label = 'Color Primario', img = 'img/icons/respray.png', onSelect = function() updateMenu('color1_categories') end},
                    {label = 'Color Secundario', img = 'img/icons/respray.png', onSelect = function() updateMenu('color2_categories') end},
            ...
            ['color1_categories'] = {
                ...
                options = {
                    {label = 'Clasico', img = 'img/icons/respray.png', onSelect = function() openColorPicker('Clasico', 'color1', false, Config.VehicleCustomisePriceMultiplier['primary_paint'], 'Clasico') end},
                    {label = 'Metalico', img = 'img/icons/respray.png', onSelect = function() openColorPicker('Metalico', 'color1', false, Config.VehicleCustomisePriceMultiplier['primary_paint'], 'Metalico') end},
                    {label = 'Mate', img = 'img/icons/respray.png', onSelect = function() openColorPicker('Mate', 'color1', false, Config.VehicleCustomisePriceMultiplier['primary_paint'], 'Mate') end},
                    {label = 'Metales', img = 'img/icons/respray.png', onSelect = function() openColorPicker('Metales', 'color1', false, Config.VehicleCustomisePriceMultiplier['primary_paint'], 'Metales') end},
                    {label = 'Cromo', img = 'img/icons/respray.png', onSelect = function() openColorPicker('Cromo', 'color1', false, Config.VehicleCustomisePriceMultiplier['primary_paint'], 'Cromo') end},
                },
                onBack = function() updateMenu('respray') end
            },
            ['color2_categories'] = {
                title = 'COLOR SECUNDARIO',
                options = {
                    {label = 'Clasico', img = 'img/icons/respray.png', onSelect = function() openColorPicker('Clasico', 'color2', false, Config.VehicleCustomisePriceMultiplier['secondary_paint'], 'Clasico') end},
                    {label = 'Metalico', img = 'img/icons/respray.png', onSelect = function() openColorPicker('Metalico', 'color2', false, Config.VehicleCustomisePriceMultiplier['secondary_paint'], 'Metalico') end},
                    {label = 'Mate', img = 'img/icons/respray.png', onSelect = function() openColorPicker('Mate', 'color2', false, Config.VehicleCustomisePriceMultiplier['secondary_paint'], 'Mate') end},
                    {label = 'Metales', img = 'img/icons/respray.png', onSelect = function() openColorPicker('Metales', 'color2', false, Config.VehicleCustomisePriceMultiplier['secondary_paint'], 'Metales') end},
                    {label = 'Cromo', img = 'img/icons/respray.png', onSelect = function() openColorPicker('Cromo', 'color2', false, Config.VehicleCustomisePriceMultiplier['secondary_paint'], 'Cromo') end},
                },
                onBack = function() updateMenu('respray') end
            },
            ['wheels'] = {
